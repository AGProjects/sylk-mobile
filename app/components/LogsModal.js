...
//
// The email scrubber used by the "Request support" flow now lives in
// app/anonymizeEmails.js so the automatic ANR/crash reporter can reuse the
// exact same substitution. Imported above as `anonymizeEmails`.
