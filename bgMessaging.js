...
<<<<<<< Updated upstream
    ...
    if(AppState.currentState == "background" && (remoteMessage.data.event === 'incoming_session' || remoteMessage.data.event === 'incoming_conference_request')) {
=======
    logger.debug("Data notification received in state " + AppState.currentState, remoteMessage, SylkNative);
