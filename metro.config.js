...
const config = {
      ...
      resolver: {
              ...
              // 'p12' is added so the Export feature's TLS keystore
              // (server-keystore.p12, generated by tools/gen-export-cert.sh)
              // is bundled as an asset and can be require()'d at runtime.
              assetExts: [...defaultConfig.resolver.assetExts.filter(ext => ext !== 'scss' && ext !== 'sass'), 'p12'],
            },
